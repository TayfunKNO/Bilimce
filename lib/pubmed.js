...
export async function searchPubMed(query, limit = 50) {
  try {
    ...
    const searchUrl = `https://eutils.ncbi.nlm.nih.gov/entrez/eutils/esearch.fcgi?db=pubmed&term=${encodeURIComponent(englishQuery)}&retmax=${limit}&retmode=json&sort=relevance`
